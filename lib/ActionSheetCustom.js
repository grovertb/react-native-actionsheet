...
class ActionSheet extends Component {
  ...
  render () {
    ...
    let wrapperStyles = [sheetStyle.wrapper];
    if(this.props.wrapperStyle) {wrapperStyles.push(this.props.wrapperStyle);}

    let overlayStyles = [styles.overlay];
    if(this.props.overlayStyle) {overlayStyles.push(this.props.overlayStyle)};
    ...
    return (
      ...
      >
        <View style={wrapperStyles}>
          <Text style={overlayStyles} onPress={this._cancel}></Text>
          <Animated.View
