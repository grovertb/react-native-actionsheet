...
class ActionSheet extends React.Component {
  ...
  shouldComponentUpdate (nextProps) {
    const prevTranslate = this._calculateHeight(this.props)
    const nextTranslate = this._calculateHeight(nextProps)

    if(prevTranslate !== nextTranslate) {
      this.translateY = nextTranslate
    }
